class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'finance.dailyBreakdown': 'Daily Breakdown',
  ...
  'new': 'New',
      ...
      'noDataForCurrentPeriod': 'No Data for Current Period',
      'noHoursRecordedThisWeek': 'No hours recorded for this week',
      'goBack': 'Go Back',
      'status': 'Status',
      'complete': 'Complete',
      ...
      'earningProgress': 'Earning Progress',
      'ofTarget': 'of target',
    ...
    'es': {
      ...
      'add': 'Añadir',
      'new': 'Nuevo',
      'finance.dailyBreakdown': 'Desglose Diario',

      'noDataForCurrentPeriod': 'Sin datos para el período actual',
      'noHoursRecordedThisWeek': 'No se registraron horas esta semana',
      'goBack': 'Volver',
      'status': 'Estado',
      'complete': 'Completo',
      ...
      'earningProgress': 'Progreso de ganancias',
    ...
    'ru': {
      ...
      'finance.dailyBreakdown': 'Ежедневная разбивка',
      'noDataForCurrentPeriod': 'Нет данных за текущий период',
      'noHoursRecordedThisWeek': 'На этой неделе часы не записаны',
      'goBack': 'Назад',
      'status': 'Статус',
      'complete': 'Завершено',
      'inProgress': 'В процессе',
      'productivityMetrics': 'Метрики продуктивности',
      'efficiency': 'Эффективность',
      'earningsOverview': 'Обзор заработка',
      'weekTotal': 'Итог недели',
      'earningProgress': 'Прогресс заработка',
      'ofTarget': 'от цели',
      'weeklyPerformance': 'Недельная производительность',
      'mon': 'Пн',
      'tue': 'Вт',
      'wed': 'Ср',
      'thu': 'Чт',
