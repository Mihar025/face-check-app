...
public class FillFormW4 {
    ...
    private final MetricsForPdfServices metricsForPdfServices;
    private static final DateTimeFormatter DATE_FMT = DateTimeFormatter.ofPattern("MM/dd/yyyy");


    public byte[] generateW4Pdf(Integer userId, Integer companyId) throws IOException {
        final String FORM = "W4";
        metricsForPdfServices.recordRequest(FORM);
...
// Line 11 (f3_11): сумма для Step 4(b) = line9 + line10
            ...
            metricsForPdfServices.recordGenerated(FORM, true);
            metricsForPdfServices.recordS3UploadTime(FORM, true,  elapsedTime);
            metricsForPdfServices.recordOperationTime(timer,"w4_success");

            return pdfBytes;
        } catch (Exception e) {
            metricsForPdfServices.recordOperationTime(timer,"w4_failed");
            metricsForPdfServices.recordGenerated(FORM, false);
            metricsForPdfServices.recordError("w4_failed", e.getMessage(), e);
           throw e;
        }
