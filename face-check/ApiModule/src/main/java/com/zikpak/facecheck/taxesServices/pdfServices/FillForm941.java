...
// Результат: facecheck_corp_123/forms/941/2024/Q1/form_941_2024_Q1_filed_20240415.pdf
            ...
            metric.recordOperationTime(timer,"941_success");


            return pdfBytes;
        } catch (Exception e) {

            metric.recordOperationTime(timer,"941_failed");
            metric.recordGenerated(FORM, false);
            metric.recordError("941_failed", e.getMessage(), e);
            throw e;
        }
    }
